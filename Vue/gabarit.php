...
<html lang="fr">
    ...
    <body>
        <div id="global">
            <header>
                <a href="index.php"><h1 id="titreBlog">Le Blogue d'Abdessamad Chafry v2.0.0.2</h1></a>
                <p>Version avec démarrage de session pour accès aux opérations de gestion</p>
                <a href="<?= $utilisateur != '' ? 'Admin' : ''; ?>Element_voiture">
                    <h4>Afficher tous les éléments de la voiture</h4>
                </a>
                <a href="apropos">
                    <h4>À propos</h4>
                </a>
